...
class MessageSerializer:
    ...
    def serialize_message(message: Any) -> Dict[str, Any]:
        try:
            if isinstance(message, dict):
                return MessageSerializer._serialize_dict_message(message)
            return MessageSerializer._serialize_object_message(message)
    ...
    def _serialize_dict_message(message: Dict) -> Dict[str, Any]:
        ...
        if "tool_calls" in message:
            result["tool_calls"] = [
                MessageSerializer._serialize_tool_call(tool_call)
